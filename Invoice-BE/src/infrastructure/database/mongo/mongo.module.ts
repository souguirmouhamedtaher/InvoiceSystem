...
import {
  ...
  TtnSimulation, TtnSimulationSchema,
...
@Module({
  imports: [
    ...
    MongooseModule.forFeatureAsync([
      ...
      { name: Client.name, useFactory: () => ClientSchema },
      { name: Supplier.name, useFactory: () => SupplierSchema },
      ...
      { name: TtnSimulation.name, useFactory: () => TtnSimulationSchema },
